...
from unicorn_server.models.ane import ANE
from unicorn_server.models.ane_flow_coefficient import ANEFlowCoefficient
...
class ResourceQueryResponse(Model):
    ...
    """
    def __init__(self, ane_matrix: List[List[ANEFlowCoefficient]]=None, anes: List[ANE]=None):
        """
        ResourceQueryResponse - a model defined in Swagger

        :param ane_matrix: The ane_matrix of this ResourceQueryResponse.
        :type ane_matrix: List[List[ANEFlowCoefficient]]
        :param anes: The anes of this ResourceQueryResponse.
        :type anes: List[ANE]
        """
        self.swagger_types = {
            'ane_matrix': List[List[ANEFlowCoefficient]],
            'anes': List[ANE]
        }
    ...
    @property
    def ane_matrix(self) -> List[List[ANEFlowCoefficient]]:
        """
        Gets the ane_matrix of this ResourceQueryResponse.

        :return: The ane_matrix of this ResourceQueryResponse.
        :rtype: List[List[ANEFlowCoefficient]]
        """
        return self._ane_matrix

    @ane_matrix.setter
    def ane_matrix(self, ane_matrix: List[List[ANEFlowCoefficient]]):
        """
